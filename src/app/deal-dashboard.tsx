...
export default function DealDashboard() {
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-extrabold mb-6 text-gray-800">Deals Admin Dashboard</h1>

      {/* Deal Form */}
      <div className="bg-white shadow-md rounded-lg p-6 mb-8">
        <h2 className="text-xl font-semibold mb-4">
          {editingId ? 'Edit' : 'Add New'} Deal
        </h2>
        ...
        {deals.map(deal => (
          ...
          >
            ...
            <div className="text-sm text-gray-500 mb-3">
              ...
              <div>
                <strong>Start:</strong> {safeFormatDate(deal.startDate)}
              </div>
              <div>
                <strong>End:</strong> {safeFormatDate(deal.endDate) || 'No Expiry'}
              </div>
            </div>
